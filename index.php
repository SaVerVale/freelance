...
<img src="image/ssjmlogo.png" class="navbar-brand">
        <a class="navbar-brand navbar-logo" href="#">Small Scale Job Marketplace</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#how"><i class="far fa-address-book"></i>How it works</a>
                </li>
                <li class="nav-item">
	...
	<div style="background:#7C9D96">
		<div class="container text-center" style="padding: 5%;">
			<div class="row">
				<div class="col-lg-6 card" style="padding: 40px 80px 40px 80px; margin-bottom: 15px; height: 100%;">
					<h1>Need works done?</h1>
					<br>
					<p style="text-align: justify; font-size: larger;">It's easy. Simply post a job you need completed and receive competitive bids from freelancers within minutes. Whatever your needs, there will be a freelancer to get it done: from web design, mobile app development, virtual assistants, product manufacturing, and graphic design (and a whole lot more). It is the simplest and safest way to get work done online.</p>
					<p></p>
					<a href="loginReg.php" class="btn btn-success btn-lg">Get Started</a>
				</div>

				<div class="col-lg-6" style="padding: 40px 80px 40px 80px; margin-bottom: 15px; box-shadow: 4px 4px 2px 5px rgba(0, 0, 0, 0.2), 0 6px 0px 0 rgba(0, 0, 0, 0.19); background:#fff; height: 100%;">
	...
	<div style="background:#7C9D96; display: flex; justify-content: center; align-items: center; height: 100vh;">
		<div class="container text-center" style="padding: 5%;">
			<div class="row">
				<div class="col-lg-5 card" style="padding: 40px 80px 40px 80px; margin-bottom: 15px; margin-right: 10px; margin-left: auto;">
					<h1>Need works done?</h1>
					<br>
					<p style="text-align: justify; font-size: larger;">It's easy. Simply post a job you need completed and receive competitive bids from freelancers within minutes. Whatever your needs, there will be a freelancer to get it done: from web design, mobile app development, virtual assistants, product manufacturing, and graphic design (and a whole lot more). It is the simplest and safest way to get work done online.</p>
					<p></p>
				...
				<div class="col-lg-5 card" style="padding: 40px 80px 40px 80px; margin-bottom: 15px; margin-left: 10px; margin-right: auto;">
					<h1>Looking for work?</h1>
					<br>
					<p style="text-align: justify; font-size: larger;">If you are an expert in any kind of computer-related or online work, then do not hesitate to join our platform. It is easy to use and payment is secured. It is a great platform for those people who are skillful. So do not miss the chance to explore the job posts and make some money.</p>
					<p></p>
	...
	<!--How it works-->
	<div style="background:#F4F2DE">
		<div class="container text-center" style="padding:4%;" id="how">
			<h1 class="card header2" style="background:#7C9D96">How it works</h1>
	...
	<!--FAQ-->
	<div class="container text-center" style="padding5%;" id="faq">
		<h1 class="card header2" style="background:#7C9D96">FAQ</h1>
		<div class="btn-group-vertical">
			...
			<button type="button" class="btn btn-custom btn-lg" data-toggle="collapse" data-target="#demo1" style="width: 1062px; background-color: #F4F2DE; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5), 0px 4px 4px rgba(0, 0, 0, 0.5);">
				<h3>I am an Employer, how will this site work for me?</h3>
			</button>
			...
			<button type="button" class="btn btn-custom btn-lg" data-toggle="collapse" data-target="#demo2" style="width: 1062px; background-color: #F4F2DE; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5), 0px 4px 4px rgba(0, 0, 0, 0.5);">
				<h3>I am a Freelancer, how will this site work for me?</h3>
			</button>
			...
			<button type="button" class="btn btn-custom btn-lg" data-toggle="collapse" data-target="#demo3" style="width: 1062px; background-color: #F4F2DE; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5), 0px 4px 4px rgba(0, 0, 0, 0.5);">
				<h3>Do I have to pay to register?</h3>
			</button>
